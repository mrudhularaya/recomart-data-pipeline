...
## Objective
This layer implements automated data profiling and structural constraint checks on raw datasets landing inside the Data Lake staging area (`data/raw/`). 
...
*   `report_generator.py`: Compiles JSON metrics into a professional, Data Quality Report PDF.
